...
app.post('/api/students', (req, res) => {
    ...
    const sql = 'INSERT INTO student_tbl (id, name, age, gender,  mobile, email, address, subjects) VALUES(?,?,?,?,?,?,?,?)';
    connection.query(sql, [id, name, age, gender, mobile, email, address, subjects], (err, result) => {
        if (err) throw err;
        let obj = {};
